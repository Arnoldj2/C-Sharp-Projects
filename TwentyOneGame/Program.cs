...
namespace TwentyOne
{
    class Program
    {
            ...
            if (answer == "yes" || answer == "y")
            {
                ...
                while (player.isActivelyPlaying && player.Balance > 0)
                {
                    ...
                    catch (FraudException ex)
                    {
                        ...
                        UpdateUpdateDbWithException(ex);
                        Console.ReadLine();
                        return;
                    }
                    ...
                    {
                        Console.WriteLine("An error occurred. Please contact your system admininstrator");
                        UpdateUpdateDbWithException(ex);
                        Console.ReadLine();
                        return;
                    }
        ...
        private static void UpdateUpdateDbWithException(Exception ex)
        {
